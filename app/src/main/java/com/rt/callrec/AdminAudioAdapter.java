...
public class AdminAudioAdapter extends RecyclerView.Adapter<AdminAudioAdapter.ViewHolder> implements Filterable {
    ...
    public AdminAudioAdapter(List<Audio> audioList, Context context) {
